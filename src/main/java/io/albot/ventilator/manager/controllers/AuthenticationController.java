...
import io.albot.ventilator.manager.model.web.AuthenticationRequest;
import io.albot.ventilator.manager.model.web.AuthenticationResponse;
import io.albot.ventilator.manager.repos.postgres.UserCredentialRepository;
import io.albot.ventilator.manager.util.JwtProvider;
...
@Api(value = "Authentication", description = "Albot Ventilator Operation Operations For Authentication.",tags = { "Authentication" })
@RestController
