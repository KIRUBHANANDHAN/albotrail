...
import com.albot.contentorchestrationservice.service.HospitalRegistrationService;
...
@Slf4j
@Api(value = "ContentOrchestrations", description = "Content Orchestration Operations For HospitalRegistrationController.")
